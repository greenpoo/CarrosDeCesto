...
public class PimpMyCesto extends World
{
	...
	// Variáveis que guardam a imagem do carro de cada jogador
    private static GreenfootImage SelectedCarP1;
    private static GreenfootImage SelectedCarP2;
	
    private int CurrentImage; // Variável usada para guardar o progresso no menu do PimpMyCesto
    
	// Variáveis que guardam os nomes de cada jogador
	private static String P1Name;
    private static String P2Name;
	
    private Car Car = new Car(); // Carro apresentado no menu do PimpMyCesto
    private GreenfootImage Car_image; // Imagem do carro apresentado no menu do PimpMyCesto
	
	// Setas usadas no menu do PimpMyCesto
    ...
    public void prepare()
    {
        setBackground("pimpmycesto.png"); // atribuição da imagem de fundo respetivo
        prepareCar();
